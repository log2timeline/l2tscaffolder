  ...
  def testWrongTestFile(self):
    ...
    if platform.system() in ['Linux']:
      ...
      with tempfile.TemporaryDirectory() as tmpdir:
        ...
        child.sendline(helper.TESTFILE_ANSWER_NOT_FOUND)
        child.expect(helper.TESTFILE_ANSWER_NOT_FOUND)

        child.expect(helper.TESTFILE_QUESTION_NOT_FOUND)
        child.sendline(helper.TESTFILE_ANSWER_ERROR)
        child.expect(helper.TESTFILE_ANSWER_ERROR)

        child.expect(helper.TESTFILE_QUESTION_INVALID)
