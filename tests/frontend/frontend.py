...
class TestOutputHandler(output_handler.BaseOutputHandler):
    ...
    def PromptInfoWithDefault(
        self, text: str, input_type: object, default: object
    ) -> str:
...
class ScaffolderFrontendTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            definition_manager.DefinitionManager.RegisterDefinition(plaso.PlasoProject)
        except KeyError:
            pass
    ...
    def testFrontend(self):
        ...
        test_output_handler.FeedLine("n")
        cwd = os.getcwd()
        test_output_handler.FeedLine(os.path.join(cwd, "test_data", "test_sqlite.db"))
        ...
        expected_string = "== Starting the scaffolder ==Gathering required information."
