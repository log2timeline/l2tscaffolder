...
class PlasoSQLiteScaffolderTest(unittest.TestCase):
    ...
    def testQueryColumns(self):
        ...
        test_string = "this should not produce anything..."
    ...
    def testPlasoSQLiteScaffolder(self):
        ...
        expected_files = frozenset(
            [
                "plaso/formatters/testing.py",
                "tests/formatters/testing.py",
        ...
        expected_init_files = frozenset(
            ["plaso/formatters/__init__.py", "plaso/parsers/sqlite_plugins/__init__.py"]
        )
