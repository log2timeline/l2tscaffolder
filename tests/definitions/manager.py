...
class DefinitionManagerTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # causes errors.
        registered_definitions = list(manager.DefinitionManager.GetDefinitionObjects())
    ...
    def testGetDefinitionByName(self):
        ...
        test_definition = manager.DefinitionManager.GetDefinitionByName("DoesNotExist")
    ...
    def testRegisteringAndDeregistering(self):
        ...
        self.assertEqual(len(list(manager.DefinitionManager.GetDefinitionNames())), 3)

        with self.assertRaises(KeyError):
            manager.DefinitionManager.RegisterDefinition(SilverTestProject)

        manager.DefinitionManager.DeregisterDefinition(SilverTestProject)
        self.assertEqual(len(list(manager.DefinitionManager.GetDefinitionNames())), 2)
