...
class TestUsersFormatterTest(test_lib.EventFormatterTestCase):
  ...
  def testGetFormatStringAttributeNames(self):
    ...
    expected_attribute_names = [
        ...
        u'has_extended_profile_fields', u'is_lifeline_institution',
        u'is_translator', u'location', u'media_count', u'pinned_tweet_id',
        u'profile_banner_url', u'profile_image_url',
